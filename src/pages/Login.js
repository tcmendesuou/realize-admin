...
function Login() {
  ...
  return (
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .rl-particle {
          position: absolute;
          border-radius: 50%;
          animation: rl-float linear infinite;
          opacity: 0;
        }
        @keyframes rl-float {
        ...
        .rl-headline {
          ...
          line-height: 1.2;
          margin-bottom: 20px;
          animation: rl-fadeUp 0.8s 0.2s ease both;
        }
        .rl-headline strong {
          font-weight: 500;
        ...
        .rl-features {
          ...
          flex-direction: column;
          gap: 14px;
          animation: rl-fadeUp 0.8s 0.4s ease both;
        }
        .rl-feature {
          display: flex;
          align-items: center;
        ...
        .rl-footer {
          ...
          text-align: center;
          font-size: 11px;
          color: rgba(123,175,212,0.3);
        }

        /* Orb SVG ring animation */
        .rl-ring {
          transform-origin: 26px 26px;
          animation: rl-rotate 8s linear infinite;
        }
        @keyframes rl-rotate {
      ...
      {/* Particles via inline script workaround */}
      <div className="rl-particles" id="rl-particles" ref={el => {
